...
export function EmptyCanvasHero({
    ...
    return (
        <div
            className="pointer-events-none absolute inset-y-0 right-0 z-[5] flex items-center justify-center px-6 transition-[left] duration-200"
        ...
        >
            <div className="pointer-events-auto w-full max-w-2xl -translate-y-8">
                ...
                <button
                    ...
                    className="mx-auto mb-2.5 flex max-w-full items-center gap-2 rounded-lg border border-border bg-card/90 px-3 py-2 text-xs shadow-sm transition-colors hover:border-ring disabled:cursor-not-allowed disabled:opacity-60"
                ...
                <PromptComposer
                    ...
                    size="hero"
                    className="bg-card/95 shadow-xl"
                />
